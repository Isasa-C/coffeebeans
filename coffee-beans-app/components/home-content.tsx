...
function PageBody({
  ...
  return (
    <section className="relative min-h-[600px] w-full overflow-visible bg-[#efe8dc] md:h-[calc(100vh-64px)] md:overflow-hidden">
      ...
      <div className="relative z-10 flex max-w-[96vw] flex-col px-6 py-8 min-[480px]:px-8 md:h-full lg:px-8 lg:py-24">
        <div>
